...
| `image.repository`                   | ZMS image name                                                                                                                                                                                                                                                                                                                                       | `wzyahoo/athenz-zms-server`                                                                                              |
...
|                                      |                                                                                                                                                                                                                                                                                                                                                      |                                                                                                                          |
| `files.zmsKey`                       | ZMS private key path                                                                                                                                                                                                                                                                                                                                 | `files/secrets/zms/private.pem`                                                                                          |
...
|                                      |                                                                                                                                                                                                                                                                                                                                                      |                                                                                                                          |
| `existingSecret`                     | Use existing secret for password, keys: `private.pem`, `jdbc`, `jdbcRo`, `keystore`, `truststore`                                                                                                                                                                                                                                                    | `""`                                                                                                                     |
